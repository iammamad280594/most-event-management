...
const SignInForm = () => {
  ...
  return (
    <form onSubmit={handleSignIn} className="max-w-md mx-auto p-6 bg-gray-800 text-white rounded-lg shadow-md space-y-6">
      ...
      <div>
        ...
        <input
          ...
          id="email"
          name="email"
          className="mt-1 block w-full px-3 py-2 border border-gray-600 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm bg-gray-900 text-white"
          value={email}
